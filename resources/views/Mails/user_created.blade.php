...
<body>
    <div style="width:100%">
        <div style="width: 600px;display:block;margin: 0 auto; margin-top:40px;">
            ...
            <img src="https://phplaravel-1003446-3537062.cloudwaysapps.com/images/mail/logo.png" alt="Nutricionista" style="width:200px; display:block; margin:0px auto; margin-bottom:50px;">
            ...
            <div style="width:100%;background-color: #339933;display: inline-flex;">
                <div style="width: 49%;padding-left:5px;">
                    <p style="margin-bottom: 2px;">© Nutricionista Natalia Segura</p>
